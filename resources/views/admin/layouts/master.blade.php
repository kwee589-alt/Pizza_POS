...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('category#listCategory') }}"><i
                        class="fa-solid fa-circle-plus"></i></i><span>Category </span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('products#addProducts') }}"><i
                        class="fa-solid fa-plus"></i></i><span>Add Products </span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('List#productsList') }}"><i
                        class="fa-solid fa-layer-group"></i><span>Product List </span></a>
            </li>

            @if (Auth::user()->role == 'superadmin')
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('paymentMethod#adminPayment') }}"><i
            ...
            <li class="nav-item">
                <a class="nav-link" href=""><i class="fa-solid fa-list"></i><span>Sale
                        Information </span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('contact#customerContact') }}"><i
                        class="fa-solid fa-message"></i><span>
                        Customer Contact </span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('info#adminOrder') }}"><i
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{ asset(Auth::user()->profile != null ? 'storage/profile/' . Auth::user()->profile : 'admin/img/undraw_profile.svg') }}">
                            </a>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('#btn-order-confirm').click(function() {
                            ...
                            $.ajax({
                                type: 'get',
                                url: '/admin/orderBoard/confirmOrder',
                                data: Object.assign({}, $orderList),
                                dataType: 'json',
                                success: function(response) {
                                    response.status == 'success' ? location.href =
                                        '/admin/orderBoard/order' : '';
                        ...
                        $('#btn-order-cancle').click(function() {
                            ...
                            $.ajax({
                                type: 'get',
                                url: '/admin/orderBoard/cancleOrder',
                                data: $data,
                                dataType: 'json',
                                success: function(response) {
                                    response.status == 'success' ? location.href =
